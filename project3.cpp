...
void display_board(){
    ...
    cout<<"tt     |     |     n" << endl;
    cout<<"tt  "<<board[0][0]<<"  |  "<<board[0][1]<<"  |  "<<board[0][2]<<"  n" << endl;
    cout<<"tt_____|_____|_____n" << endl;
    cout<<"tt     |     |     n" << endl;
    cout<<"tt  "<<board[1][0]<<"  |  "<<board[1][1]<<"  |  "<<board[1][2]<<"  n" << endl;
    cout<<"tt_____|_____|_____n" << endl;
    cout<<"tt     |     |     n" << endl;
    cout<<"tt  "<<board[2][0]<<"  |  "<<board[2][1]<<"  |  "<<board[2][2]<<"  n" << endl;
    cout<<"tt     |     |     n" << endl;
}
